...
interface Zone {
  id: string
  name: string
  type: 'patrol' | 'restricted' | 'charging'
  polygon: number[][]
  color: string
...
const ZONE_TYPES = ['patrol', 'restricted', 'charging'] as const
      ...
      <div className="flex-1 overflow-y-auto">
        {loading ? (
          ...
          zones.map((zone) => (
            <div
              key={zone.id}
              className="flex items-center gap-2 px-3 py-2 border-b border-[#1a1a1a] hover:bg-[#1a1a1a]"
            >
              <div
