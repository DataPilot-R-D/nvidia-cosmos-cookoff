...
import { CameraTile, type CameraSource } from './camera-wall/CameraTile'
...
export function CameraWallModule({ windowId }: ModuleProps): ReactNode {
  ...
  // Available sources from store
  const availableSources = useMemo(() => buildSources(camerasMap), [camerasMap])
  ...
  const displaySources = useMemo(() => {
    return validSelectedIds
      ...
      .filter((s): s is CameraSource => s !== undefined)
  }, [validSelectedIds, availableSources])
